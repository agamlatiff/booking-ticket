    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-surface-dark rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col min-h-[600px]">
        ...
        <div className="p-5 border-b border-gray-100 dark:border-gray-800 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <button className="flex items-center justify-center gap-2 bg-primary hover:bg-slate-800 text-white px-5 py-2.5 rounded-xl text-sm font-medium shadow-lg shadow-primary/25 transition-colors whitespace-nowrap">
        ...
        <div className="p-5 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-sm text-gray-500 dark:text-gray-400">
            Showing <span className="font-bold text-gray-900 dark:text-white">1-{Math.min(tickets.length, 10)}</span> of{" "}
            <span className="font-bold text-gray-900 dark:text-white">{tickets.length}</span> tickets
          </div>
