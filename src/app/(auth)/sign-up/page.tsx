...
const SignUpPage = () => {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 lg:p-6">
      {/* Background */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1507812984078-917a274065be?w=1920')",
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-background/80 to-background dark:from-black/20 dark:via-background-dark/80 dark:to-background-dark backdrop-blur-[4px]" />
      </div>

      {/* Card */}
      <div className="relative z-10 w-full max-w-[1000px] bg-white dark:bg-surface-dark rounded-2xl shadow-card flex flex-col md:flex-row overflow-hidden border border-white/50 dark:border-white/5 md:min-h-[650px]">
        {/* Left Side - Image */}
      ...
      <div className="absolute bottom-4 left-0 w-full text-center pointer-events-none">
        <p className="text-[10px] text-gray-400/60 dark:text-white/20">
          © 2024 FlyHigher Inc. All rights reserved.
        </p>
      </div>
    </div>
  );
